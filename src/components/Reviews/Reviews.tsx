    ...
    <section id="reviews" className={styles.reviews}>
      <div className={styles.banner}>
        ...
        <div className={`container ${styles.bannerContent}`}>
          ...
          <h1 className={styles.title}>Что говорят наши гости</h1>
          <p className={styles.lead}>
            Живые впечатления после экскурсий по Нижнему Новгороду —
            от индивидуальных прогулок до семейных и корпоративных туров.
          </p>
        </div>
      </div>
